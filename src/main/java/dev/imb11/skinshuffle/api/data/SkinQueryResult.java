...
public record SkinQueryResult(boolean usesDefaultSkin, @Nullable String skinURL, @Nullable String modelType,
                              @Nullable String textureSignature, @Nullable String textureValue, @Nullable String capeURL) {
    public static final SkinQueryResult EMPTY_RESULT = new SkinQueryResult(true, null, null, null, null, null);
